...
int LED_LEVER_SWITCH_5 = 1;
int LED_LEVER_SWITCH_1 = 1;
int LED_LEVER_SIGNAL_A2 = 1;
int LED_LEVER_SIGNAL_A1 = 1;
int LED_SWITCHING_PERMISSION_LOCK = 1;
int LED_LEVER_ROUTE_A = 1;
int LED_LEVER_ROUTE_BERENBACH = 1;
...
int SWITCHING_PERMISSION_LOCK = 1;
